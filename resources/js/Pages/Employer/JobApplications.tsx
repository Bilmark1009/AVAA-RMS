...
const inputClass =
    "w-full rounded-xl border border-gray-200 bg-gray-50 text-gray-800 text-base px-3 py-2.5 focus:outline-none focus:ring-2 focus:ring-avaa-primary focus:border-transparent transition-all placeholder-gray-400";
...
function RejectModal({
    ...
    const handleSubmit = () => {
        ...
        setSending(true);
        router.post(
            route("employer.jobs.applications.reject", {
                job: jobId,
                application: app.id,
            }),
            {
            ...
            <div className="relative bg-white rounded-2xl shadow-2xl w-full max-w-md flex flex-col">
                ...
                <div className="px-6 pb-5 pt-2">
                    ...
                    <p className="text-[10px] text-gray-400 mt-1">
                        This will be emailed to the applicant.
                    </p>
                </div>
...
function ApproveModal({
    ...
    useEffect(() => {
        if (
            ...
            form.interview_type !== "In-Person" &&
            form.location_or_link === employerAddress
        ) {
    ...
    const handleSubmit = () => {
        ...
        setSending(true);
        router.post(
            route("employer.jobs.applications.approve", {
                job: jobId,
                application: app.id,
            }),
            form,
                ...
                <div className="overflow-y-auto flex-1 px-6 pb-5 pt-2 space-y-4">
                    ...
                    <div className="grid grid-cols-2 gap-3">
                        <div>
                            ...
                            <select
                                ...
                                onChange={(e) =>
                                    set("interview_type", e.target.value)
                                }
                                className={inputClass}
                            >
                        ...
                        <div>
                            ...
                            <input
                                ...
                                onChange={(e) =>
                                    set("interviewer_name", e.target.value)
                                }
                                className={inputClass}
                    ...
                    {showLink && (
                        <div>
                            ...
                            <input
                                ...
                                onChange={(e) =>
                                    set("location_or_link", e.target.value)
                                }
                                className={inputClass}
                    ...
                    {showAddress && (
                        <div>
                            ...
                            {employerAddress && (
                                <p className="text-[10px] text-gray-400 mt-1">
                                    Pre-filled from your company address. You
                                    can edit it.
                                </p>
                            )}
                        </div>
                ...
                <div className="absolute left-0 top-full mt-1 z-30 bg-white border border-gray-200 rounded-xl shadow-lg overflow-hidden min-w-[140px]">
                    ...
                    {status !== "pending" && (
                        <button
                            onClick={() => {
                                router.patch(
                                    route("employer.jobs.applications.status", {
                                        job: jobId,
                                        application: appId,
                                    }),
                                    { status: "pending" },
                ...
                <div className="overflow-y-auto flex-1 px-6 pb-6 pt-2 space-y-5">
                    ...
                    <div className="border border-gray-100 rounded-xl p-5">
                        <div className="flex items-center gap-2 mb-4">
                            <span className="w-6 h-6 rounded-lg bg-avaa-primary-light text-avaa-teal flex items-center justify-center text-xs font-bold">
                                1
                            </span>
                            <h4 className="text-sm font-bold text-avaa-dark">
                        ...
                        <div className="grid grid-cols-2 gap-x-8 gap-y-3">
                            <div>
                                ...
                                <p className="text-sm font-semibold text-avaa-dark mt-0.5">
                                    {fullName}
                                </p>
                            </div>
                            <div>
                    ...
                    <div className="border border-gray-100 rounded-xl p-5">
                        ...
                        <div className="grid grid-cols-2 gap-x-8 gap-y-3">
                            <div>
                                ...
                                <p className="text-sm font-semibold text-avaa-dark mt-0.5">
                                    {ad?.current_job_title ??
                                        u.profile?.current_job_title ??
                                        "—"}
                                </p>
                            </div>
                            <div>
                            ...
                            <div className="mt-4">
                                ...
                                <div className="flex flex-wrap gap-2">
                                    {(
                                        ...
                                        <span
                                            key={s}
                                            className="px-3 py-1 bg-avaa-primary-light text-avaa-teal text-xs font-semibold rounded-full border border-avaa-primary/20"
                                        >
                                            {s}
                                        </span>
                                    ))}
                        ...
                        {resumePath ? (
                            <div className="flex items-center gap-3 border border-gray-200 rounded-xl p-3">
                                ...
                                <a
                                    ...
                                    target="_blank"
                                    rel="noreferrer"
                                    className="text-gray-400 hover:text-avaa-teal transition-colors p-1"
                                >
                                    <IcoEye />
                                </a>
                            </div>
                ...
                <div className="px-6 py-4 border-t border-gray-100 flex items-center justify-end gap-3 flex-shrink-0 rounded-b-2xl">
                    ...
                    {app.status === "pending" && (
                        <>
                            ...
                            <button
                                onClick={onApprove}
                                className="px-5 py-2 bg-avaa-primary hover:bg-avaa-primary-hover text-white text-sm font-semibold rounded-xl transition-colors"
                            >
                                Approve
                            </button>
                        </>
        ...
        >
            ...
            {viewApp && (
                <ApplicantModal
                    ...
                    onReject={() => {
                        setRejectApp(viewApp);
                        setViewApp(null);
                    }}
                    onApprove={() => {
                        setApproveApp(viewApp);
                        setViewApp(null);
                    }}
                />
            )}
                ...
                <div className="px-6 pb-5 -mt-8 relative z-10">
                    <div className="flex items-end justify-between">
                        <div className="flex items-end gap-4">
                            <div
                                className={`w-16 h-16 rounded-2xl ring-4 ring-white ${avatarColor(job.id)} flex items-center justify-center text-white text-xl font-bold shadow-md`}
                            >
                                {job.company
                                    .split(/\s+/)
                                    .map((w) => w[0])
                            ...
                            <div className="pb-0.5">
                                <h2 className="text-xl font-bold text-avaa-dark">
                                    {job.title}
                                </h2>
                        ...
                        <Link
                            href={route("employer.jobs.index")}
                            className="flex items-center gap-1.5 text-xs font-semibold text-avaa-muted hover:text-avaa-teal transition-colors mb-1"
                        >
                            View all Jobs
                            <svg
                                width="12"
                ...
                <div className="inline-flex items-center bg-white border border-gray-200 rounded-xl p-1 gap-0.5 shadow-sm flex-wrap">
                    {(
                        ...
                        >
                            {tab}
                            <span
                                className={`ml-1 text-[10px] font-bold px-1.5 py-0.5 rounded-full ${filter === tab ? "bg-white/20 text-white" : "bg-gray-100 text-gray-500"}`}
                            >
                                {counts[tab]}
                            </span>
                        </button>
                    ...
                    <table className="w-full">
                        <thead>
                            <tr className="border-b border-gray-100 bg-gray-50/50">
                                ...
                                <th className="px-6 py-3 text-xs font-semibold text-gray-400 uppercase tracking-widest text-right">
                                    Action
                                </th>
                            </tr>
                        </thead>
