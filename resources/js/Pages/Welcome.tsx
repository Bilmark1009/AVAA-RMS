...
const C =
    "w-full max-w-[1600px] mx-auto px-6 sm:px-10 lg:px-16 xl:px-20 2xl:px-24";
...
export default function Welcome() {
    ...
    return (
        <>
            ...
            <nav className="fixed top-0 left-0 right-0 z-50 bg-white/90 backdrop-blur-md border-b border-gray-200">
                <div className={`${C} flex items-center justify-between h-16`}>
                    ...
                    <div className="hidden md:flex items-center gap-7 lg:gap-9 text-sm font-medium text-avaa-muted">
                        {[
                            ...
                            <a
                                key={href}
                                href={href}
                                className="hover:text-avaa-dark transition-colors"
                            >
                                {label}
                            </a>
                        ))}
                    ...
                    <div className="flex md:hidden items-center gap-1">
                        <Link
                            href={route("login")}
                            className="px-3 py-1.5 text-sm font-semibold text-avaa-dark"
                        >
                            Sign In
                        </Link>
                        <button
            ...
            <div
                ref={sectionsRef}
                className="min-h-screen bg-white overflow-x-hidden pt-16"
            >
                {/* ════════════════════════════════════
                    HERO
                ════════════════════════════════════ */}
                <section className="relative bg-gradient-to-br from-avaa-primary-light via-white to-avaa-primary-light overflow-hidden">
                    {/* Dot pattern */}
                    <div
                        className="absolute top-0 right-0 w-64 sm:w-[420px] h-64 sm:h-[420px] opacity-30 pointer-events-none"
                        style={{
                            backgroundImage:
                                "radial-gradient(circle, #7EB0AB 1.5px, transparent 1.5px)",
                    ...
                    <div
                        ...
                        style={{
                            backgroundImage:
                                "radial-gradient(circle, #122431 1.5px, transparent 1.5px)",
                        ...
                        <div className="grid md:grid-cols-2 gap-12 lg:gap-16 xl:gap-20 items-center">
                            ...
                            >
                                ...
                                <h1 className="text-[44px] sm:text-[60px] lg:text-[68px] xl:text-[76px] 2xl:text-[84px] font-extrabold text-avaa-dark leading-[1.05] tracking-tight mb-5">
                                    Find Your
                                    <br />
                                    <span className="text-avaa-primary">
                                        Ideal Job
                                    </span>
                                </h1>
                                ...
                                <p className="text-base sm:text-lg text-avaa-text mb-9 max-w-lg leading-relaxed">
                                    ...
                                    top companies. Your next career move starts
                                    here.
                                </p>
                                ...
                                >
                                    <div className="flex items-center gap-2 flex-1 px-3 min-w-0">
                                        <svg
                                            className="flex-shrink-0 text-avaa-muted"
                                            width="18"
                                            height="18"
                                            viewBox="0 0 24 24"
                                            fill="none"
                                ...
                                <div className="flex items-center gap-6 sm:gap-10 flex-wrap">
                                    {[
                                        ...
                                        >
                                            ...
                                            <div>
                                                <p className="text-2xl sm:text-3xl font-extrabold text-avaa-dark">
                                                    {num}
                                                </p>
                            ...
                            {/* Right — hero card */}
                            <div
                                className={`relative hidden md:flex justify-center lg:justify-end transition-all duration-700 delay-200 ${heroVisible ? "opacity-100 translate-y-0" : "opacity-0 translate-y-8"}`}
                            >
                                <div className="relative w-full max-w-[500px] xl:max-w-[540px]">
                                    <div className="bg-white rounded-3xl shadow-2xl shadow-avaa-dark/10 p-7 lg:p-9 border border-gray-200">
                                        <div className="flex items-center gap-3 mb-5">
                                            <div className="w-12 h-12 rounded-full bg-avaa-dark flex items-center justify-center text-white font-bold text-sm flex-shrink-0">
                                                TN
                                            </div>
                                            <div className="min-w-0">
                                                <p className="font-bold text-avaa-dark text-sm truncate">
                                        ...
                                        <div className="flex flex-wrap gap-2 mb-6">
                                            <span className="px-3 py-1 rounded-full text-xs font-medium bg-avaa-primary/10 text-avaa-teal">
                                                React
                                            </span>
                                            <span className="px-3 py-1 rounded-full text-xs font-medium bg-avaa-primary-light text-avaa-teal">
                                                TypeScript
                                            </span>
                                            <span className="px-3 py-1 rounded-full text-xs font-medium bg-avaa-primary/10 text-avaa-primary">
                                                Tailwind CSS
                                            </span>
                                        </div>
                                        <div className="flex items-center justify-between">
                                            <span className="text-xl font-extrabold text-avaa-dark">
                                                $120k–$160k
                                            </span>
                                            <span className="px-5 py-2 rounded-lg text-xs font-semibold text-white bg-avaa-primary">
                                                Apply Now
                                            </span>
                                        </div>
                                    </div>
                                    ...
                                    <div className="absolute -top-5 -left-6 bg-white rounded-2xl shadow-lg px-4 py-3 flex items-center gap-3 border border-gray-200 float-1">
                                        ...
                                        <div>
                                            <p className="text-xs font-bold text-avaa-dark">
                                                Unlocking your
                                            </p>
                                            <p className="text-xs font-bold text-avaa-primary">
                                                potential
                                            </p>
                                        </div>
                                    </div>
                                    ...
                                    <div className="absolute -bottom-5 -right-5 bg-white rounded-2xl shadow-lg px-4 py-3 flex items-center gap-3 border border-gray-200 float-2">
                                        ...
                                        <div>
                                            ...
                                            <p className="text-[11px] text-avaa-muted">
                                                hired this month
                                            </p>
                                        </div>
                                    </div>
                    ...
                    >
                        <div className="flex gap-14 sm:gap-24 marquee-track w-max">
                            {[
                                ...
                                <span
                                    key={`${name}-${i}`}
                                    className="text-base sm:text-lg font-bold text-avaa-muted/40 tracking-wider select-none whitespace-nowrap"
                                >
                                    {name}
                                </span>
                            ))}
                ...
                <section
                    id="how-it-works"
                    className="py-20 sm:py-28 bg-white section-enter"
                >
                    <div className={C}>
                        <div className="text-center mb-14">
                            <span className="inline-block px-4 py-1.5 rounded-full bg-avaa-primary-light text-avaa-teal text-xs font-semibold mb-4 uppercase tracking-wider">
                                How It Works
                            </span>
                            <h2 className="text-3xl sm:text-4xl lg:text-5xl font-extrabold text-avaa-dark tracking-tight">
                        ...
                        <div className="grid grid-cols-1 sm:grid-cols-3 gap-6 lg:gap-10">
                            {[
                                ...
                                >
                                    ...
                                    <h3 className="text-lg font-bold text-avaa-dark mb-2">
                                        {item.title}
                                    </h3>
                ...
                <section className="py-20 sm:py-28 bg-avaa-primary-light section-enter">
                    <div className={C}>
                        <div className="text-center mb-14">
                            <span className="inline-block px-4 py-1.5 rounded-full bg-avaa-primary/15 text-avaa-teal text-xs font-semibold mb-4 uppercase tracking-wider">
                                Top Companies
                            </span>
                            <h2 className="text-3xl sm:text-4xl lg:text-5xl font-extrabold text-avaa-dark tracking-tight mb-4">
                                Many Top Companies
                                <br className="hidden sm:block" /> Posted Here
                            </h2>
                            <p className="text-sm sm:text-base text-avaa-text max-w-xl mx-auto">
                                Leading organizations trust AVAA to find the
                        ...
                        <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-4 gap-4 sm:gap-5">
                            {TOP_COMPANIES.map((name) => (
                                <div
                                    key={name}
                                    className="bg-white rounded-2xl border border-gray-200 p-5 sm:p-6 flex items-center gap-4 hover:shadow-sm hover:border-avaa-primary/30 transition-all"
                                >
                        ...
                        <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-4 gap-4 sm:gap-5">
                            {CATEGORIES.map((cat) => (
                                ...
                                >
                                    ...
                                    <h3 className="text-sm font-bold text-avaa-dark mb-1 group-hover:text-avaa-primary transition-colors leading-tight">
                                        {cat.label}
                                    </h3>
                                    <p className="text-xs text-avaa-muted">
                                        {cat.count} jobs
                ...
                <section className="relative overflow-hidden bg-avaa-dark section-enter">
                    ...
                    <div
                        ...
                        style={{
                            backgroundImage:
                                "radial-gradient(circle, #7EB0AB 1px, transparent 1px)",
                    ...
                    <div className={`${C} py-20 sm:py-28 relative z-10`}>
                        <div className="grid md:grid-cols-2 gap-12 lg:gap-20 xl:gap-28 items-center">
                            <div>
                                <span className="inline-block px-4 py-1.5 rounded-full bg-avaa-primary/20 text-avaa-primary text-xs font-semibold mb-6 uppercase tracking-wider">
                                    Smart Matching
                                </span>
                                ...
                                <p className="text-sm sm:text-base text-avaa-muted mb-9 max-w-lg leading-relaxed">
                                    Our intelligent matching system analyzes
                                    your skills and preferences to connect you
                                    ...
                                    <div className="space-y-3">
                                        <div className="bg-avaa-dark-light rounded-2xl rounded-tl-none px-4 py-3">
                                            <p className="text-sm text-white/90">
                                                Hi! I found{" "}
                                                <span className="font-bold text-avaa-primary">
                                                    12 jobs
                                                </span>{" "}
                                                matching your profile. Shall I
                                                show you the top picks?
                                            </p>
                                        </div>
                ...
                <section
                    id="jobs"
                    className="py-20 sm:py-28 bg-avaa-primary-light section-enter"
                >
                    <div className={C}>
                        <div className="text-center mb-14">
                            <span className="inline-block px-4 py-1.5 rounded-full bg-avaa-primary/15 text-avaa-teal text-xs font-semibold mb-4 uppercase tracking-wider">
                            ...
                            <p className="text-sm sm:text-base text-avaa-text max-w-xl mx-auto">
                                Hand-picked opportunities updated daily to help
                                you discover the best roles.
                            </p>
                        </div>
                                ...
                                >
                                    <div className="flex items-center gap-3 mb-4">
                                        ...
                                        <div className="flex-1 min-w-0">
                                            <h3 className="font-bold text-avaa-dark text-sm group-hover:text-avaa-primary transition-colors truncate">
                                                {job.title}
                                            </h3>
                                            <p className="text-xs text-avaa-muted">
                                                {job.company}
                                    ...
                                    <div className="flex items-center gap-3 mb-4 text-xs text-avaa-muted flex-wrap">
                                        ...
                                        <span className="px-2 py-0.5 rounded-full bg-avaa-primary-light text-avaa-teal font-medium">
                                            {job.type}
                                        </span>
                                    </div>
                                    <div className="flex items-center justify-between">
                                        <span className="text-base font-extrabold text-avaa-dark">
                                            {job.salary}
                                        </span>
                                        <Link
                                            href={route("login")}
                ...
                >
                    <div className={C}>
                        <div className="text-center mb-14">
                            ...
                            <p className="text-sm sm:text-base text-avaa-text max-w-xl mx-auto">
                                Hear what professionals say about their AVAA
                                experience.
                            </p>
                        </div>
                        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 sm:gap-8">
                            {TESTIMONIALS.map((t) => (
                                <div
                                    key={t.name}
                                    className="bg-white rounded-2xl border border-gray-200 p-7 sm:p-8 hover:shadow-lg hover:border-avaa-primary/30 transition-all duration-300"
                                >
                                    ...
                                    <p className="text-sm sm:text-base text-avaa-text leading-relaxed mb-6">
                                        "{t.text}"
                                    </p>
                                    <div className="flex items-center gap-3">
                                        ...
                                        <div>
                                            <p className="text-sm font-bold text-avaa-dark">
                                                {t.name}
                                            </p>
                                            <p className="text-xs text-avaa-muted">
                                                {t.role}
                ...
                <section className="relative overflow-hidden bg-avaa-dark section-enter">
                    ...
                    />
                    <div
                        className={`${C} py-20 sm:py-28 relative z-10 text-center`}
                    >
                        <p className="text-sm font-semibold text-avaa-primary mb-3 uppercase tracking-wider">
                    ...
                    <div className="relative bg-white w-full max-w-2xl max-h-[80vh] overflow-hidden rounded-3xl shadow-2xl flex flex-col animate-in fade-in zoom-in duration-300">
                        ...
                        <div className="flex-1 overflow-y-auto p-6 sm:p-8 text-sm text-avaa-text leading-relaxed">
                            <section className="space-y-4">
                                ...
                                <p>
                                    Welcome to AVAA. We value your privacy and
                                ...
                                <p>
                                    ...
                                    to us when you create an account, such as
                                    your name, email address, resume details,
                                    and professional history to facilitate job
                                    matching.
                                </p>
                                ...
                                <p>
                                    ...
                                    services, including our AI Smart Matching
                                    system. We do not sell your personal data to
                                ...
                                <p>
                                    ...
                                    and security measures to protect your
                                ...
                                <p>
                                    ...
                                    through your account settings or by
