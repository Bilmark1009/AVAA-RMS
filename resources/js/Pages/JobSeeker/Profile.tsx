...
══════════════════════════════════════════════ */
export default function JobSeekerProfilePage({ user, profile, experiences, timelineEvents = [], documents = [] }: Props) {
                    ...
                    <div className="bg-white rounded-2xl border border-gray-200 p-6">
                        ...
                        {experiences && experiences.length > 0 ? (
                            <div className="space-y-6">
                                ...
                                {timelineEvents && timelineEvents.length > 0 && timelineEvents.map((evt) => (
                                    <div key={`evt-${evt.id}`} className="flex gap-3 relative">
                                        <div className="w-10 h-10 rounded-xl border border-gray-200 bg-gray-50 text-gray-500 flex items-center justify-center flex-shrink-0 mt-0.5 relative z-10 shadow-sm">
                                            ...
                                            <div className="flex items-start justify-between gap-2">
                                                <div>
                                                    <p className="text-sm font-semibold text-gray-700">
                                                        {evt.event_type === 'status_change' ? 'Status Update' : 'Event'}
                                                    </p>
                            ...
                            <div>
                                {timelineEvents && timelineEvents.length > 0 ? (
                                    ...
                                    <p className="text-sm text-gray-400 italic">
                                        No experience or timeline events added yet.
                                    </p>
                                )}
                            </div>
                        )}
                                        ...
                                        <div className="min-w-0">
                                            {certificationLink(c) ? (
                                                <a
                                                    ...
                                                    target="_blank"
                                                    rel="noreferrer"
                                                    className="text-sm font-medium text-avaa-dark truncate hover:underline"
                                                >
