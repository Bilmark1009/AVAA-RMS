...
                        </div>
                    </div>
                    {/* ══ MOBILE ONLY: Stats & Details ══ */}
                    <div className="lg:hidden space-y-6">
                        {/* Mobile Operational Overview */}
                        <div className="bg-white p-6 rounded-2xl border border-gray-200 shadow-sm">
                            <h3 className="text-sm font-bold text-gray-800 mb-4">Operational Overview</h3>
                            <div className="grid grid-cols-2 gap-3">
                                <div className="bg-gray-50 p-4 rounded-xl text-center border border-gray-100 flex flex-col justify-center">
                                    <p className="text-xl font-bold text-avaa-teal">{postedJobs.length}</p>
                                    <p className="text-[10px] text-gray-400 font-black uppercase mt-1">Total Job Post</p>
                                </div>
                                <div className="bg-gray-50 p-4 rounded-xl text-center border border-gray-100 flex flex-col justify-center">
                                    <p className="text-xl font-bold text-avaa-teal">0</p>
                                    <p className="text-[10px] text-gray-400 font-black uppercase mt-1">Total Applicant</p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div className="bg-white p-6 rounded-2xl border border-gray-200 shadow-sm mb-6">
                            <h3 className="text-sm font-bold text-gray-800 mb-4">Company Details</h3>
                            <div className="grid grid-cols-2 gap-4">
                                {[
                                    { label: "Company", value: member.company },
                                    { label: "Industry", value: member.industry },
                                    { label: "Location", value: member.location },
                                    { label: "Size", value: member.company_size },
                                ].map((detail) => (
                                    <div key={detail.label}>
                                        <p className="text-[10px] text-gray-400 font-black uppercase tracking-wider">{detail.label}</p>
                                        <p className="text-sm font-bold text-gray-700 break-words">{detail.value || "N/A"}</p>
                                    </div>
                                ))}
                            </div>
                        </div>
...
               <div className="hidden lg:block w-full lg:w-80 space-y-6 shrink-0">
                    <div className="bg-white p-6 rounded-2xl border border-gray-200 shadow-sm">
