                                ...
                                <div className="flex-1 min-w-0">
                                    ...
                                    <div className="flex flex-wrap gap-2 mt-3">
                                        ...
                                        {job.work_arrangement && (
                                            <span className="px-3 py-1 bg-purple-50 text-purple-600 text-sm font-semibold rounded-full border border-purple-100">
                                                {job.work_arrangement}
                                            </span>
                                        )}
                                        {job.industry && (
                                        ...
                                        {job.deadline && (
                                            <span className="px-3 py-1 bg-red-50 text-red-500 text-sm font-semibold rounded-full border border-red-100 flex items-center gap-1.5">
